...
function AccountSetting() {
    ...
    const onSubmit = type => {
        ...
        if (type === 'profilePicture') {
            ...
            formData.append('username', userFilledData.username);
        } else if (type === 'email') {
            formData.append('email', userFilledData.email);
        } else if (type === 'about') {
            formData.append('about', userFilledData.about);
        } else if (type === 'country') {
            formData.append('country', userFilledData.country);
        } else if (type === 'city') {
            formData.append('city', userFilledData.city);
        }
